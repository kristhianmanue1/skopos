...
| 15 | C-10: cursor de ingesta — decisión 8 + ADR de lectura incremental (P-002 §3.3) 🔒 | **Gate cumplido** (remedición 2026-08-28 con load registrado: ciclo 22.6–39.1 s vs intervalo 5 s, `docs/evidencia/remedicion-ciclo-c10-2026-08-28.md`); **ADR-011 propuesto**, pendiente de 🔒 del dueño | — |
